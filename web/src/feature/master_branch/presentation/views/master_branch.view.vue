  ...
  >
    <section class="master-data-page__hero">
      <div class="master-data-page__hero-head">
        ...
        <button
          type="button"
          class="btn btn-success master-data-page__hero-action"
      ...
      >
        ...
        <template #body="{ item }">
          <tr>
            <td
              data-label="Aksi"
              class="master-data-page__col-action"
            >
              <div class="master-data-page__action-cell">
                <button
                  type="button"
                  class="btn btn-outline-primary btn-sm"
                  @click="vm.openBranchActionModal(item)"
                >
                  Aksi
                </button>
              </div>
        ...
        <div class="modal-content border-0 master-data-page__modal-content">
          <div class="modal-header master-data-page__modal-header">
            ...
            <button
              ...
              class="btn-close"
              aria-label="Tutup"
              @click="vm.closeBranchActionModal()"
            />
          </div>
          <div class="modal-body master-data-page__modal-body">
            <div class="d-grid gap-2">
              <button
                type="button"
                class="btn btn-outline-primary w-100 text-sm-start"
              ...
              <button
                type="button"
                class="btn btn-outline-danger w-100 text-sm-start"
