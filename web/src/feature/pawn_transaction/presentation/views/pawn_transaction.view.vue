<template>
  <section v-if="isLoading" class="card p-4">
    <div class="d-flex align-items-center gap-3">
      ...
      <div>
        <div class="fw-bold">Loading Pawn Transaction</div>
  ...
  <section v-else-if="error" class="card p-4">
    ...
    <button class="btn btn-primary" type="button" @click="vm.getPawnTransactionData()">
      Muat ulang
    </button>
  </section>
...
import { pawnTransactionViewModel } from '@feature/pawn_transaction/presentation/view_models/pawn_transaction.vm';

const vm = pawnTransactionViewModel();
