<template>
  <section class="pawn-contract-page__content-section">
    ...
    <h2 class="pawn-contract-page__section-title mb-1">
      Daftar kontrak yang sudah masuk proses lelang
    </h2>
    ...
    >
      ...
      <template #empty>
        <LocalDbFeedbackStateComponent
          state="empty"
          title="Belum ada data kontrak lelang"
          description="Tidak ada kontrak dengan status auctioned di database lokal yang sedang dibuka."
          note="Periksa filter yang diterapkan atau tunggu transaksi lelang tercatat."
          :framed="false"
          compact
        />
      </template>
