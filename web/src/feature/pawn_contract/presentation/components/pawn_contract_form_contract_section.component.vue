    ...
    <div class="row g-3 mt-1">
      ...
      <div class="col-12 col-md-4">
        <div class="pawn-contract-create-page__readonly-label">
          <label class="form-label mb-0" for="contractDate">Tanggal mulai gadai</label>
          <span class="pawn-contract-create-page__readonly-badge">
            Otomatis
          </span>
        </div>
        <div class="pawn-contract-create-page__readonly-field">
          <input id="contractDate" :value="form.contractDate"
            class="form-control pawn-contract-create-page__readonly-input"
            :class="{ 'is-invalid': !!fieldErrors.contractDate }" type="date" readonly aria-readonly="true">
        ...
        <div class="form-text">
          Tanggal mulai gadai ditentukan otomatis dari hari ini.
        </div>
      </div>
