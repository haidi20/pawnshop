    ...
    <section class="card border-0 shadow-sm pawn-contract-page__overview">
      <div class="card-body p-3">
        ...
        <div class="pawn-contract-page__content">
          ...
          <PawnContractRedeemedSectionComponent
            v-else-if="activeIndexTab === pawnContractIndexTabKey.RedeemedContracts"
            :data-table-vm="redeemedDataTableVm"
            :has-active-filters="hasActiveFilters"
            :format-date="formatDate"
            :format-currency="formatCurrency"
            :get-contract-status-label="getContractStatusLabel"
          ...
          <PawnContractAuctionSectionComponent
            v-else-if="activeIndexTab === pawnContractIndexTabKey.AuctionContracts"
            :data-table-vm="auctionDataTableVm"
            :has-active-filters="hasActiveFilters"
            :format-date="formatDate"
            :format-currency="formatCurrency"
            :get-contract-status-label="getContractStatusLabel"
          ...
          <PawnContractRefundSectionComponent
            v-else-if="activeIndexTab === pawnContractIndexTabKey.RefundContracts"
            :data-table-vm="refundDataTableVm"
            :get-due-state-class="getDueStateClass"
            :has-active-filters="hasActiveFilters"
            :format-date="formatDate"
            :format-currency="formatCurrency"
