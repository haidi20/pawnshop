...
CREATE DATABASE IF NOT EXISTS `pawnshop` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `branch_investors` (
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_branch_investors_period` (
        `branch_id`,
        `investor_id`,
        `start_date`
    ),
    ...
    CONSTRAINT `fk_branch_investors_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_branch_investors_investor` FOREIGN KEY (`investor_id`) REFERENCES `investors` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `user_branch_assignments` (
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_user_branch_assignments` (
        `user_id`,
        `branch_id`,
        `assigned_at`
    ),
    KEY `idx_user_branch_assignments_branch_id` (`branch_id`),
    CONSTRAINT `fk_user_branch_assignments_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_user_branch_assignments_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `login_sessions` (
    ...
    CONSTRAINT `fk_login_sessions_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `customer_documents` (
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_customer_documents_type_number` (
        `document_type`,
        `document_number`
    ),
    KEY `idx_customer_documents_customer_id` (`customer_id`),
    CONSTRAINT `fk_customer_documents_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `customer_contacts` (
    ...
    CONSTRAINT `fk_customer_contacts_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `item_types` (
    ...
    CONSTRAINT `fk_item_types_category` FOREIGN KEY (`category_id`) REFERENCES `item_categories` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `storage_locations` (
    ...
    CONSTRAINT `fk_storage_locations_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pawn_contracts` (
    ...
    CONSTRAINT `fk_pawn_contracts_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT `fk_pawn_contracts_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT `fk_pawn_contracts_created_by_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pawn_items` (
    ...
    `current_location_status` ENUM(
        ...
        'returned',
        'other'
    ) NOT NULL DEFAULT 'in_office',
    `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_pawn_items_contract_sequence` (
        `contract_id`,
        `item_sequence`
    ),
    ...
    CONSTRAINT `fk_pawn_items_contract` FOREIGN KEY (`contract_id`) REFERENCES `pawn_contracts` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_pawn_items_category` FOREIGN KEY (`category_id`) REFERENCES `item_categories` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_pawn_items_item_type` FOREIGN KEY (`item_type_id`) REFERENCES `item_types` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_pawn_items_current_location` FOREIGN KEY (`current_location_id`) REFERENCES `storage_locations` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pawn_item_accessories` (
    ...
    CONSTRAINT `fk_pawn_item_accessories_pawn_item` FOREIGN KEY (`pawn_item_id`) REFERENCES `pawn_items` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pawn_item_issues` (
    ...
    CONSTRAINT `fk_pawn_item_issues_pawn_item` FOREIGN KEY (`pawn_item_id`) REFERENCES `pawn_items` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pawn_item_location_movements` (
    ...
    CONSTRAINT `fk_pawn_item_location_movements_pawn_item` FOREIGN KEY (`pawn_item_id`) REFERENCES `pawn_items` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_pawn_item_location_movements_from_location` FOREIGN KEY (`from_location_id`) REFERENCES `storage_locations` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_pawn_item_location_movements_to_location` FOREIGN KEY (`to_location_id`) REFERENCES `storage_locations` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_pawn_item_location_movements_user` FOREIGN KEY (`moved_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `contract_payments` (
    ...
    CONSTRAINT `fk_contract_payments_contract` FOREIGN KEY (`contract_id`) REFERENCES `pawn_contracts` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_contract_payments_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `contract_extensions` (
    ...
    CONSTRAINT `fk_contract_extensions_contract` FOREIGN KEY (`contract_id`) REFERENCES `pawn_contracts` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_contract_extensions_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `auction_transactions` (
    ...
    CONSTRAINT `fk_auction_transactions_contract` FOREIGN KEY (`contract_id`) REFERENCES `pawn_contracts` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_auction_transactions_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `branch_cash_accounts` (
    ...
    CONSTRAINT `fk_branch_cash_accounts_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `branch_cash_transactions` (
    ...
    CONSTRAINT `fk_branch_cash_transactions_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_branch_cash_transactions_cash_account` FOREIGN KEY (`cash_account_id`) REFERENCES `branch_cash_accounts` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_branch_cash_transactions_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `branch_debts` (
    ...
    CONSTRAINT `fk_branch_debts_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_branch_debts_creditor_branch` FOREIGN KEY (`creditor_branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_branch_debts_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `branch_debt_payments` (
    ...
    CONSTRAINT `fk_branch_debt_payments_debt` FOREIGN KEY (`debt_id`) REFERENCES `branch_debts` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_branch_debt_payments_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `inter_branch_transfers` (
    ...
    CONSTRAINT `fk_inter_branch_transfers_source_branch` FOREIGN KEY (`source_branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT `fk_inter_branch_transfers_target_branch` FOREIGN KEY (`target_branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT `fk_inter_branch_transfers_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `investor_capital_transactions` (
    ...
    CONSTRAINT `fk_investor_capital_transactions_investor` FOREIGN KEY (`investor_id`) REFERENCES `investors` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT `fk_investor_capital_transactions_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT `fk_investor_capital_transactions_transfer` FOREIGN KEY (`transfer_id`) REFERENCES `inter_branch_transfers` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_investor_capital_transactions_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `branch_item_settings` (
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_branch_item_settings_period` (
        `branch_id`,
        `item_type_id`,
        `effective_from`
    ),
    KEY `idx_branch_item_settings_item_type_id` (`item_type_id`),
    CONSTRAINT `fk_branch_item_settings_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT `fk_branch_item_settings_item_type` FOREIGN KEY (`item_type_id`) REFERENCES `item_types` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `notifications` (
    ...
    CONSTRAINT `fk_notifications_branch` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_notifications_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_notifications_contract` FOREIGN KEY (`contract_id`) REFERENCES `pawn_contracts` (`id`) ON UPDATE CASCADE ON DELETE SET NULL,
    CONSTRAINT `fk_notifications_read_by_user` FOREIGN KEY (`read_by_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
